...
# ====================== Create directories ===================
if (!dir.exists(sprintf("../../results/networks/small/%s/", TAO))){
 dir.create(sprintf("../../results/networks/small/%s/", TAO))
}

if (mutual_info){
 if (!dir.exists(sprintf("../../results/networks/small/%s/mutual_info", TAO))){
 dir.create(sprintf("../../results/networks/small/%s/mutual_info", TAO))
 }
  
} else{
 if (!dir.exists(sprintf("../../results/networks/small/%s/corr/", TAO))){
   dir.create(sprintf("../../results/networks/small/%s/corr/", TAO))
 }
  }
#===============================================================
...
write.csv(data.frame(red_info[[as.character(tao)]][["Clusters"]]$membership), sprintf("../../results/networks/small/%s/node_info.csv", tao))
...
if (log_transform){
  if (!dir.exists("../../results/networks/small/log_transformed")){
    dir.create("../../results/networks/small/log_transformed")
  }
   #============= GRAPH
    if (mutual_info){
      if (!dir.exists(sprintf("../../results/networks/small/log_transformed/%s/mutual_info/graph/", TAO))){
       dir.create(sprintf("../../results/networks/small/log_transformed/%s/mutual_info/graph/", TAO))
       write.graph(A,sprintf("../../results/networks/small/log_transformed/%s/mutual_info/graph/edges_%s.txt", tao, tao),format="ncol")
       }
    } else {
      if (!dir.exists(sprintf("../../results/networks/small/log_transformed/%s/corr/graph/", TAO))){
       dir.create(sprintf("../../results/networks/big/small/log_transformed/corr/graph/", TAO))
       write.graph(A,sprintf("../../results/networks/small/log_transformed/%s/corr/graph/edges_%s.txt", tao, tao),format="ncol")
       }
    }
    ...
    if (mutual_info){
      if (!dir.exists(sprintf("../../results/networks/small/log_transformed/%s/mutual_info/degree/", TAO))){
       dir.create(sprintf("../../results/networks/small/log_transformed/%s/mutual_info/degree/", TAO))
       write.csv(degree.table, sprintf("../../results/networks/small/log_transformed/%s/mutual_info/degree/degree.csv", tao, tao),format="ncol")
       }
    } else {
      if (!dir.exists(sprintf("../../results/networks/small/log_transformed/%s/corr/degree/", TAO))){
       dir.create(sprintf("../../results/networks/small/log_transformed/%s/corr/degree/", TAO))
       write.csv(degree.table, sprintf("../../results/networks/small/log_transformed/%s/corr/degree/degree.csv", tao),format="ncol")
       }
    }
  
  
} else{ # No LOG transform
    #============= GRAPH
    if (mutual_info){
      if (!dir.exists(sprintf("../../results/networks/small/%s/mutual_info/graph/", TAO))){
       dir.create(sprintf("../../results/networks/small/%s/mutual_info/graph/", TAO))
       write.graph(A,sprintf("../../results/networks/small/%s/mutual_info/graph/edges_%s.txt", tao, tao),format="ncol")
       }
    } else {
      if (!dir.exists(sprintf("../../results/networks/small/%s/corr/graph/", TAO))){
       dir.create(sprintf("../../results/networks/small/%s/corr/graph/", TAO))
       write.graph(A,sprintf("../../results/networks/small/%s/corr/graph/edges_%s.txt", tao, tao),format="ncol")
       }
    }
    ...
    if (mutual_info){
      if (!dir.exists(sprintf("../../results/networks/small/%s/mutual_info/degree/", TAO))){
       dir.create(sprintf("../../results/networks/small/%s/mutual_info/degree/", TAO))
       write.csv(degree.table, sprintf("../../results/networks/small/%s/mutual_info/degree/degree.csv", tao, tao),format="ncol")
       }
    } else {
      if (!dir.exists(sprintf("../../results/networks/small/%s/corr/degree/", TAO))){
       dir.create(sprintf("../../results/networks/small/%s/corr/degree/", TAO))
       write.csv(degree.table, sprintf("../../results/networks/small/%s/corr/degree/degree.csv", tao),format="ncol")
       }
    }
