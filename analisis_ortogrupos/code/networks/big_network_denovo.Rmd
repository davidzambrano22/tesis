    ...
    if (grepl("denovo$", dir.)){
      ...
      for (file. in list.files(dir.)){
        if (grepl("^A_TPM", file.)){
          ...
          most.var.HOGS.names <- read.csv("../../results/filtered_genes/0.10_most_variable_genes.csv")$`Var1` %>% as.vector()
          ...
          if (mutual_info){
            if (!log_transform){
              if (file.exists("../../results/networks/big/raw/mutual_info/sim_matrix/sim_matrix.csv")){
                message("Loading mututal information for all genes of interest from results/networks/big/raw/mutual_info/sim_matrix/sim_matrix.csv ...")
                sim.matrix <- read.csv("../../results/networks/big/raw/mutual_info/sim_matrix/sim_matrix.csv")
                ...
                saving.dir <- "../../results/networks/big/raw/mutual_info/sim_matrix/"
              ...
              if (file.exists("../../results/networks/big/log_transformed/mutual_info/sim_matrix/sim_matrix.csv")){
                message("Loading mututal information for all genes of interest from results/networks/big/log_transformed/mutual_info/sim_matrix/sim_matrix.csv ...")
                sim.matrix <- read.csv("../../results/networks/big/raw/mutual_info/sim_matrix/sim_matrix.csv")
                ...
                saving.dir <- "../../results/networks/big/log_transformed/mutual_info/sim_matrix/"
                tryCatch({write.csv(sim.matrix, paste0(saving.dir,"sim_matrix.csv"))},
                     error = function(e) {create.dir(saving.dir)
                       write.csv(sim.matrix, paste0(saving.dir,"sim_matrix.csv"))})
              }
  ...
  {  
    ...
    if (log_transform){
      ...
      if (!mutual_info){
        ...
        saving.dir <- sprintf("../../results/networks/big/log_transformed/corr/%s/Modules/", tao)
      ...
      #=============================IF  MUTUAL INFO ==============================
        ...
        saving.dir <- sprintf("../../results/networks/big/log_transformed/mutual_info/%s/Modules/", tao)
        tryCatch({write.csv(data.frame(network_info[["log"]][["corr"]][[as.character(tao)]][["Modules"]]$membership), paste0(saving.dir,"Modules.csv"))},
                 error = function(e) {create.dir(saving.dir)
      ...
      if (!mutual_info){
        ...
        saving.dir <- sprintf("../../results/networks/big/raw/corr/%s/Modules/", tao)
      ...
      #=============================IF  MUTUAL INFO ==============================
        ...
        saving.dir <- sprintf("../../results/networks/big/raw/mutual_info/%s/Modules/", tao)
